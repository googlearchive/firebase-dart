...
class FullMetadata
  ...
  DateTime get timeCreated => jsObject.timeCreated == null ? null : DateTime.parse(jsObject.timeCreated);

  /// Returns the time it was last updated as a [DateTime].
  DateTime get updated => jsObject.updated == null ? null : DateTime.parse(jsObject.updated);
