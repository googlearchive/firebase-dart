...
class Storage extends JsObjectWrapper<storage_interop.StorageJsImpl> {
  ...
  static Storage getInstance(storage_interop.StorageJsImpl jsObject) =>
      _expando[jsObject] ??= Storage._fromJsObject(jsObject);
...
class StorageReference
  ...
  static StorageReference getInstance(
      ...
      _expando[jsObject] ??= StorageReference._fromJsObject(jsObject);
  ...
  /// the upload.
  ///
  /// [blob] must be one of [Blob] or [Uint8List].
  /// See also
...
class FullMetadata
  ...
  static FullMetadata getInstance(jsObject) =>
      _expando[jsObject] ??= FullMetadata._fromJsObject(jsObject);
...
class UploadTask extends JsObjectWrapper<storage_interop.UploadTaskJsImpl> {
  ...
  late final Future<UploadTaskSnapshot> _future =
  ...
  static UploadTask getInstance(storage_interop.UploadTaskJsImpl jsObject) =>
      _expando[jsObject] ??= UploadTask._fromJsObject(jsObject);
  ...
  late final StreamController<UploadTaskSnapshot> _changeController =
      _createController();

  /// Stream for upload task state changed event.
  Stream<UploadTaskSnapshot> get onStateChanged => _changeController.stream;

  StreamController<UploadTaskSnapshot> _createController() {
    late StreamController<UploadTaskSnapshot> _changeController;
    final nextWrapper = allowInterop(
      (storage_interop.UploadTaskSnapshotJsImpl data) {
    ...
    void stopListen() {
      ...
      _onStateChangedUnsubscribe = null;
    }

    return _changeController = StreamController<UploadTaskSnapshot>.broadcast(
...
class UploadTaskSnapshot
  ...
  static UploadTaskSnapshot getInstance(
      ...
      _expando[jsObject] ??= UploadTaskSnapshot._fromJsObject(jsObject);
...
class ListResult extends JsObjectWrapper<storage_interop.ListResultJsImpl> {
  ...
  static ListResult getInstance(storage_interop.ListResultJsImpl jsObject) =>
      _expando[jsObject] ??= ListResult._fromJsObject(jsObject);
