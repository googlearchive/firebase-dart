...
// May be is not very clean to do that :s
List _transformArg(List args) {
...
class Firebase extends Query {
   ...
   */
   Firebase push({value}) => new Firebase.fromJsObject(_fb.callMethod('push', _transformArg([value])));
